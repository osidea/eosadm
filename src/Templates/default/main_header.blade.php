...
<div class="page-header page-header-inverse">
    ...
    <div class="navbar navbar-inverse navbar-transparent">
        <div class="navbar-header">
            <a class="navbar-brand" href="{{admurl()}}"><img src="/resources/default/img/logo_light.png" alt=""></a>
        ...
        <div class="navbar-collapse collapse" id="navbar-mobile">
            <p class="navbar-text"><span class="label bg-info-400 ">Beta</span></p>
                ...
                <ul class="nav navbar-nav">
                    ...
                    <li class="dropdown dropdown-user">
                        <a class="dropdown-toggle" data-toggle="dropdown">
                            <img src="/resources/default/img/avatar.jpg" alt="">
        ...
        <div class="navbar-collapse collapse" id="navbar-second-toggle">
            <ul class="nav navbar-nav navbar-nav-material">
                @foreach($nav as $value)
                    ...
                    @else
                        @if($value['style_type'] == 0)
                            <li class="dropdown {{$value['active']}}">
                                <a href="javascript:;" class="dropdown-toggle" data-toggle="dropdown">
                                    {{$value['name']}} <span class="caret"></span>
                                </a>
                                <ul class="dropdown-menu width-200">
                                    @foreach($value['_child'] as $_value)
                                        @if(!isset($_value['_child']))
                                            <li class="{{$_value['active']}}"><a href="{{$_value['url']}}"><i class="{{$_value['icon']}}"></i> {{$_value['name']}}</a></li>
                                        @else
                                            <li class="dropdown-submenu {{$_value['active']}}">
                                                <a href="javascript:;" class="dropdown-toggle" data-toggle="dropdown"><i class="{{$_value['icon']}}"></i> {{$_value['name']}}</a>
                                                <ul class="dropdown-menu">
                                                    @foreach($_value['_child'] as $__value)
                                                        @if(!isset($__value['_child']))
                                                            <li class="{{$__value['active']}}"><a href="{{$__value['url']}}">{{$__value['name']}}</a></li>
                                                        @else
                                                            <li class="dropdown-submenu">
                                                                <a href="javascript:;">{{$__value['name']}}</a>
                                                                <ul class="dropdown-menu">
                                                                    @foreach($__value['_child'] as $___value)
                                                                        <li class="{{$___value['active']}}"><a href="{{$___value['url']}}">{{$___value['name']}}</a></li>
                                                                    @endforeach
                                                                </ul>
                                                            </li>
                                                        @endif
                        ...
                        @if($value['style_type'] == 1)
                            <li class="dropdown mega-menu mega-menu-wide {{$value['active']}}">
                                <a href="#" class="dropdown-toggle" data-toggle="dropdown">{{$_value['name']}} <span
                                            class="caret"></span></a>
                                            ...
                                            <div class="col-md-3">
                                                ...
                                                <ul class="menu-list">
                                                    <li>
                                                        ...
                                                        <ul>
                                                            ...
                                                            <li><a href="form_controls_extended.html">Extended
                                                                    controls</a></li>
                                                            <li><a href="form_floating_labels.html">Floating labels</a>
                                                            </li>
                                                            <li>
                                                                <a href="#">Selects</a>
                                                                <ul>
                                                                    <li><a href="form_select2.html">Select2 selects</a>
                                                                    </li>
                                                            ...
                                                            <li><a href="form_dual_listboxes.html">Dual Listboxes</a>
                                                            </li>
                                                    ...
                                                    <li>
                                                        ...
                                                        <ul>
                                                            <li><a href="editor_summernote.html">Summernote editor</a>
                                                            </li>
                                                            <li><a href="editor_ckeditor.html">CKEditor</a></li>
                                                            <li><a href="editor_wysihtml5.html">WYSIHTML5 editor</a>
                                                            </li>
                                                    ...
                                                    <li>
                                                        ...
                                                        <ul>
                                                            <li><a href="picker_date.html">Date &amp; time pickers</a>
                                                            </li>
                                                    ...
                                                    <li>
                                                        <a href="#"><i class="icon-insert-template"></i> Form
                                                            layouts</a>
                                                        <ul>
                                                            <li><a href="form_layout_vertical.html">Vertical form</a>
                                                            </li>
                                                ...
                                                <ul class="menu-list">
                                                    <li>
                                                        ...
                                                        <ul>
                                                            ...
                                                            <li><a href="components_dropdowns.html">Dropdown menus</a>
                                                            </li>
                                                            <li><a href="components_tabs.html">Tabs component</a></li>
                                                            <li><a href="components_pills.html">Pills component</a></li>
                                                            <li><a href="components_navs.html">Accordion and navs</a>
                                                            </li>
                                                            ...
                                                            <li><a href="components_labels.html">Labels and badges</a>
                                                            </li>
                                                            <li><a href="components_loaders.html">Loaders and bars</a>
                                                            </li>
                                                            <li><a href="components_thumbnails.html">Thumbnails</a></li>
                                                            <li><a href="components_page_header.html">Page header</a>
                                                            </li>
                                                            <li><a href="components_breadcrumbs.html">Breadcrumbs</a>
                                                            </li>
                                                            <li><a href="components_media.html">Media objects</a></li>
                                                            <li><a href="components_affix.html">Affix and Scrollspy</a>
                                                            </li>
                                                        </ul>
                                                    </li>
                                                    <li>
                                                        ...
                                                        <ul>
                                                            ...
                                                            <li><a href="panels_draggable.html">Draggable panels</a>
                                                            </li>
                                                        </ul>
                                                    </li>
                                                    <li>
                                                        ...
                                                        <ul>
                                                            <li><a href="appearance_text_styling.html">Text styling</a>
                                                            </li>
                                                            <li><a href="appearance_typography.html">Typography</a></li>
                                                            <li><a href="appearance_helpers.html">Helper classes</a>
                                                            </li>
                                                            <li><a href="appearance_syntax_highlighter.html">Syntax
                                                                    highlighter</a>
                                                            </li>
                                                            <li><a href="appearance_content_grid.html">Grid system</a>
                                                            </li>
                                                        </ul>
                                                    </li>
                                                    <li>
                                                        ...
                                                        <ul>
                                                            ...
                                                            <li><a href="extra_sliders_ion.html">Ion range sliders</a>
                                                            </li>
                                                            <li><a href="extra_trees.html">Dynamic tree views</a></li>
                                                            <li><a href="extra_context_menu.html">Context menu</a></li>
                                                            <li><a href="extra_fab.html">Floating action buttons</a>
                                                            </li>
                                                        </ul>
                                                    </li>
                                                    <li>
                                                        ...
                                                        <ul>
                                                            <li><a href="tools_session_timeout.html">Session timeout</a>
                                                            </li>
                                            ...
                                            <div class="col-md-3">
                                                ...
                                                <ul class="menu-list">
                                                    <li>
                                                        ...
                                                        <ul>
                                                            <li><a href="extension_image_cropper.html">Image cropper</a>
                                                            </li>
                                                    ...
                                                    <li>
                                                        ...
                                                        <ul>
                                                            ...
                                                            <li><a href="fullcalendar_styling.html">Event styling</a>
                                                            </li>
                                                            <li><a href="fullcalendar_formats.html">Language and
                                                                    time</a></li>
                                                            <li><a href="fullcalendar_advanced.html">Advanced usage</a>
                                                            </li>
                                                        </ul>
                                                    </li>
                                                    <li>
                                                        ...
                                                        <ul>
                                                            <li><a href="internationalization_switch_direct.html">Direct
                                                                    translation</a></li>
                                                            <li><a href="internationalization_switch_query.html">Querystring
                                                                    parameter</a></li>
                                                            <li><a href="internationalization_on_init.html">Set language
                                                                    on init</a>
                                                            </li>
                                                            ...
                                                            <li>
                                                                <a href="internationalization_callbacks.html">Callbacks</a>
                                                            </li>
                                                        </ul>
                                                    </li>
                                                </ul>
                                            ...
                                            <div class="col-md-3">
                                                ...
                                                <ul class="menu-list">
                                                    ...
                                                    <li>
                                                        ...
                                                        <ul>
                                                            <li><a href="datatable_basic.html">Basic initialization</a>
                                                            </li>
                                                            <li><a href="datatable_styling.html">Basic styling</a></li>
                                                            <li><a href="datatable_advanced.html">Advanced examples</a>
                                                            </li>
                                                            <li><a href="datatable_sorting.html">Sorting options</a>
                                                            </li>
                                                            <li><a href="datatable_api.html">Using API</a></li>
                                                            <li><a href="datatable_data_sources.html">Data sources</a>
                                                            </li>
                                                        </ul>
                                                    </li>
                                                    <li>
                                                        <a href="#"><i class="icon-alignment-unalign"></i> Data tables
                                                            extensions</a>
                                                        <ul>
                                                            ...
                                                            <li><a href="datatable_extension_row_reorder.html">Row
                                                                    reorder</a></li>
                                                            <li><a href="datatable_extension_fixed_columns.html">Fixed
                                                                    columns</a>
                                                            </li>
                                                            ...
                                                            <li><a href="datatable_extension_select.html">Select</a>
                                                            </li>
                                                            <li>
                                                                <a href="#">Buttons</a>
                                                                <ul>
                                                                    <li><a href="datatable_extension_buttons_init.html">Initialization</a>
                                                                    </li>
                                                                    <li>
                                                    ...
                                                    <li>
                                                        <a href="#"><i class="icon-file-spreadsheet"></i>
                                                            Handsontable</a>
                                                        <ul>
                                                            <li><a href="handsontable_basic.html">Basic
                                                                    configuration</a></li>
                                                            <li><a href="handsontable_advanced.html">Advanced setup</a>
                                                            </li>
                                                            <li><a href="handsontable_cols.html">Column features</a>
                                                            </li>
                                                            <li><a href="handsontable_cells.html">Cell features</a></li>
                                                            <li><a href="handsontable_types.html">Basic cell types</a>
                                                            </li>
                                                            ...
                                                            <li><a href="handsontable_context.html">Context menu</a>
                                                            </li>
                                                        </ul>
                                                    </li>
                                                    <li>
                                                        ...
                                                        <ul>
                                                            <li><a href="table_responsive.html">Responsive basic
                                                                    tables</a></li>
                                                            <li><a href="datatable_responsive.html">Responsive data
                                                                    tables</a></li>
                                                        </ul>
                                                    </li>
                                                </ul>
                ...
                <li class="dropdown">
                    ...
                    <ul class="dropdown-menu dropdown-menu-right">
                        @foreach($setlist as $value)
                            <li><a href="{{admurl('system/config?to='. ($value -> key))}}"> {{$value -> name}}</a></li>
                        @endforeach
                        <li class="divider"></li>
                        <li><a href="{{admurl('system/config', ['mode' => 'tab'])}}"><i class="icon-gear"></i> 系统设置</a></li>
                    </ul>
                </li>
            </ul>
        </div>
    ...
    {{--<ul class="fab-menu fab-menu-top-right" data-fab-toggle="click">--}}
        {{--<li>--}}
            {{--<a class="fab-menu-btn btn bg-info-300 btn-float btn-rounded btn-icon">--}}
            ...
            {{--<ul class="fab-menu-inner">--}}
                ...
                {{--<li>--}}
                    {{--<div data-fab-label="Chat with Jack">--}}
                        ...
                        {{--</a>--}}
                        {{--<span class="status-mark border-info-400"></span>--}}
                    {{--</div>--}}
                {{--</li>--}}
            {{--</ul>--}}
        {{--</li>--}}
